 ...
 * Generated for Laravel 5.2.12 on 2016-02-09.
 *
...
namespace {
    ...
    class LaraCart extends \LukePOLO\LaraCart\Facades\LaraCart{
         ...
         * @static 
         */
        public static function setInstance($instance = 'default'){
            return \LukePOLO\LaraCart\LaraCart::setInstance($instance);
        }
        ...
        public static function get($instance = 'default'){
            return \LukePOLO\LaraCart\LaraCart::get($instance);
        }
         ...
         * @static 
         */
        public static function getAttribute($attribute, $defaultValue = null){
            return \LukePOLO\LaraCart\LaraCart::getAttribute($attribute, $defaultValue);
        }
        ...
        public static function getAttributes(){
            return \LukePOLO\LaraCart\LaraCart::getAttributes();
        }
        ...
        public static function setAttribute($attribute, $value){
            return \LukePOLO\LaraCart\LaraCart::setAttribute($attribute, $value);
        }
        ...
        public static function update(){
            return \LukePOLO\LaraCart\LaraCart::update();
        }
        ...
        public static function removeAttribute($attribute){
            return \LukePOLO\LaraCart\LaraCart::removeAttribute($attribute);
        }
         ...
         * @static 
         */
        public static function addLine($itemID, $name = null, $qty = 1, $price = '0.00', $options = array(), $taxable = true){
            return \LukePOLO\LaraCart\LaraCart::addLine($itemID, $name, $qty, $price, $options, $taxable);
        }
         ...
         * @static 
         */
        public static function add($itemID, $name = null, $qty = 1, $price = '0.00', $options = array(), $taxable = true, $lineItem = false){
            return \LukePOLO\LaraCart\LaraCart::add($itemID, $name, $qty, $price, $options, $taxable, $lineItem);
        }
        
        /**
         * Adds the cartItem into the cart session
         *
         * @param \LukePOLO\LaraCart\CartItem $cartItem
         * @return \LukePOLO\LaraCart\CartItem 
         * @static 
         */
        public static function addItem($cartItem){
            return \LukePOLO\LaraCart\LaraCart::addItem($cartItem);
        }
         ...
         *
         * @param $itemHash
         * @return \LukePOLO\LaraCart\CartItem | null
         * @static 
         */
        public static function getItem($itemHash){
            return \LukePOLO\LaraCart\LaraCart::getItem($itemHash);
        }
        ...
        public static function getItems(){
            return \LukePOLO\LaraCart\LaraCart::getItems();
        }
         ...
         * @static 
         */
        public static function updateItem($itemHash, $key, $value){
            return \LukePOLO\LaraCart\LaraCart::updateItem($itemHash, $key, $value);
        }
         ...
         * @static 
         */
        public static function removeItem($itemHash){
            return \LukePOLO\LaraCart\LaraCart::removeItem($itemHash);
        }
        ...
        public static function emptyCart(){
            return \LukePOLO\LaraCart\LaraCart::emptyCart();
        }
        ...
        public static function destroyCart(){
            return \LukePOLO\LaraCart\LaraCart::destroyCart();
        }
        ...
        public static function getCoupons(){
            return \LukePOLO\LaraCart\LaraCart::getCoupons();
        }
        ...
        public static function findCoupon($code){
            return \LukePOLO\LaraCart\LaraCart::findCoupon($code);
        }
        
        /**
         * Applies a coupon to the cart
         *
         * @param \LukePOLO\LaraCart\CouponContract $coupon
         * @static 
         */
        public static function addCoupon($coupon){
            return \LukePOLO\LaraCart\LaraCart::addCoupon($coupon);
        }
        ...
        public static function removeCoupon($code){
            return \LukePOLO\LaraCart\LaraCart::removeCoupon($code);
        }
        ...
        public static function getFee($name){
            return \LukePOLO\LaraCart\LaraCart::getFee($name);
        }
         ...
         * @static 
         */
        public static function addFee($name, $amount, $taxable = false, $options = array()){
            return \LukePOLO\LaraCart\LaraCart::addFee($name, $amount, $taxable, $options);
        }
        ...
        public static function removeFee($name){
            return \LukePOLO\LaraCart\LaraCart::removeFee($name);
        }
         ...
         * @static 
         */
        public static function taxTotal($format = true){
            return \LukePOLO\LaraCart\LaraCart::taxTotal($format);
        }
         ...
         * @static 
         */
        public static function total($format = true, $withDiscount = true){
            return \LukePOLO\LaraCart\LaraCart::total($format, $withDiscount);
        }
         ...
         * @static 
         */
        public static function subTotal($format = true, $withDiscount = true){
            return \LukePOLO\LaraCart\LaraCart::subTotal($format, $withDiscount);
        }
         ...
         * @static 
         */
        public static function count($withItemQty = true){
            return \LukePOLO\LaraCart\LaraCart::count($withItemQty);
        }
        ...
        public static function formatMoney($number, $locale = null, $internationalFormat = null, $format = true){
            return \LukePOLO\LaraCart\LaraCart::formatMoney($number, $locale, $internationalFormat, $format);
        }
         ...
         * @static 
         */
        public static function feeTotals($format = true){
            return \LukePOLO\LaraCart\LaraCart::feeTotals($format);
        }
        ...
        public static function getFees(){
            return \LukePOLO\LaraCart\LaraCart::getFees();
        }
         ...
         * @static 
         */
        public static function totalDiscount($format = true){
            return \LukePOLO\LaraCart\LaraCart::totalDiscount($format);
        }
